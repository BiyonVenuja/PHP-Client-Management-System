function EditAdmin(id, fname, email, pass, contact) {
    this.id = id;
    this.fname = fname;
    this.email = email;
    this.pass = pass;
    this.contact = contact;   
        ...
        this.container.querySelector(".edit-form-save").addEventListener("click", () => {
            ...
            ConfirmDialog("Confirm", "Are you sure you want to edit this Admin?", () => {
                ...
                r.open("GET", "editAdmin.php?id=" +id_edited+ "&name=" + fname_edited + "&email=" + email_edited + "&pass=" + pass_edited + "&contact=" + contact_edited+"&preID="+this.id+"", true);
