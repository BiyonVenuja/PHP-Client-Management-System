...
<body class="bg-white">
    ...
    <section class="one-section">
        ...
        <div id="clientFormBtn" class="btn btn-primary ">New Client</div>
    </section>
        ...
        <div class="table-container">
            <table class="table table-striped table-hover col-4 text-center" id="user-table">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td>' . $row['date'] . '</td>';
                    echo '<td><span class="edit-btn">Edit</span><span class="del-btn"> Delete</span><a href="events.php?id='.$row['id'].'" class="evt-btn"> Events</span></td>';
                    echo '</tr>';
                }
